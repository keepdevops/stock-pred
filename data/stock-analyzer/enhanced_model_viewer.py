"""
Enhanced Model Viewer - Improved UI for viewing saved models
"""
import os
import glob
import pickle
...
from view_saved_model import view_model, list_all_saved_models

class EnhancedModelViewer(tk.Toplevel):
    def __init__(self, parent, models_dir="/Users/moose/stock-pred/data/stock-analyzer/models"):
        super().__init__(parent)
        self.title("Enhanced Model Viewer")
    ...
    def view_selected_model(self):
        ...
        try:
            ...
            self.summary_text.insert(tk.END, f"Model File Size: {model_size:.2f} MB\n")
...
def launch_model_viewer(parent):
    """Launch the enhanced model viewer"""
    viewer = EnhancedModelViewer(parent)
    return viewer
