...
from stock_market_analyzer.modules.tabs.models_tab import ModelsTab

class ModelsProcess(QWidget):
    """Process class for the Models tab."""
    ...
    def __init__(self):
        ...
        try:
            ...
            self.layout.addWidget(self.models_tab)
            
            # Subscribe to message bus
            self.message_bus.subscribe("Models", self.handle_message)
            
            self.logger.info("Models tab initialized successfully")
            
        except Exception as e:
            error_msg = f"Error initializing Models tab: {str(e)}"
...
def main():
    """Main function to start the Models tab process."""
    try:
        # Set up logging
        logging.basicConfig(
            level=logging.INFO,
        ...
        # Create and show the models process
        ...
        logging.error(f"Error in Models tab process: {str(e)}")
