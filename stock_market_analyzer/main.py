...
print("Modules directory:", os.path.join(project_root, "stock_market_analyzer/modules"))
print("Database module path:", os.path.join(project_root, "stock_market_analyzer/modules/database.py"))
...
from stock_market_analyzer.modules.data_service import DataService
...
def main():
    ...
    try:
        ...
        logger.info(f"Modules directory: {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'modules')}")
        logger.info(f"Database module path: {os.path.join(os.path.dirname(os.path.abspath(__file__)), 'modules', 'database.py')}")
        ...
        # Create and show GUI
        global gui_instance
        gui_instance = StockGUI(db_connector, data_service, ai_agent, trading_agent)
        gui_instance.show()
